window.onload = function () {
    ...
    playBtn.onclick = function () {
        ...
        if (musicAudio.paused) {
            playBtn.style.backgroundImage = 'url(images/播放.png)';
            musicAudio.play();
        } else {
            playBtn.style.backgroundImage = 'url(images/暂停.png)';
            musicAudio.pause();
        }
    };
    ...
    modeBtn.onclick = function () {
        if (musicAudio.loop) {
            ...
            this.style.backgroundImage = 'url(images/随机.png)';
        } else {
            musicAudio.loop = true;
            this.style.backgroundImage = 'url(images/单曲循环.png)';
        }
    };
